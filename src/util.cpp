...
const char * const BITCOIN_CONF_FILENAME = "bitcf.conf";
const char * const BITCOIN_PID_FILENAME = "bitcfd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FirstBitcoinCapitalCorp";
#else
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/FirstBitcoinCapitalCorp";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    string s =
       ...
       "OTC:BITCF\n"
       "CUSIP: 31932X105\n\n"
       "For license see the accompanying file COPYING.txt.";
    return s;
}
