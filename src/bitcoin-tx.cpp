...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcf-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcf-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded FirstBitcoinCapitalCorp transaction") + "\n" +
              "  bitcf-tx [options] -create [commands]   " + _("Create hex-encoded FirstBitcoinCapitalCorp transaction") + "\n" +
              "\n";
