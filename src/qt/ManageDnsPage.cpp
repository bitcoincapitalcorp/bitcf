...
ManageDnsPage::ManageDnsPage(QWidget*parent): QDialog(parent) {
    ...
    auto description = new QLabel(tr(
		"BitDNS is a decentralized <a href=\"https://en.wikipedia.org/wiki/Domain_Name_System\">domain names system</a>"
		" supporting a full range of DNS <a href=\"https://en.wikipedia.org/wiki/List_of_DNS_record_types\">records.</a><br/>"
		"On this page you can prepare BitDNS name-value pairs to use them in 'Manage names' tab.<br/>"
    ...
    addLineEdit(form, "SD", tr("SD"), tr("Subdomain - BitDNS feature"));
